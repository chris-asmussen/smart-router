...
[private vulnerability report](https://github.com/chris-asmussen/smart-router/security/advisories/new).
...
smart-router runs on your local machine. By design, it can read and change the
...
- smart-router runs each downstream MCP server with the command, the arguments,
